/**
 * @file LEDcontrol_LEGACYHAT.cpp
 * @author V1pr < viper (at) vipernet (dot) hu >
 * @brief YardForce LED driver for OpenMower SC600ECO non-uC CoverUI + HAT https://github.com/ClemensElflein/OpenMower
 * @version 0.1
 * @date 2024-08-18
 *
 ...
 */
#include <Arduino.h>
#include "LEDcontrol_LEGACYHAT.hpp"
...
void LEDcontrolLegacyHAT::sequence_animate_handler()
{
...
void LEDcontrolLegacyHAT::show_countdown_state(unsigned int sec, LED_state state)
{
 ...
 */
void LEDcontrolLegacyHAT::sequence_countdown_handler()
{
 ...
 */
unsigned int LEDcontrolLegacyHAT::boot_animation() // A short boot animation which return the amount of ms it will take
{
 ...
 */
void LEDcontrolLegacyHAT::set_base10_leds(char digit)
{
...
void LEDcontrolLegacyHAT::force_off_num_seq_leds(bool force)
{
...
LEDcontrolLegacyHAT leds(kPinByLedNum, sizeof(kPinByLedNum) / sizeof(uint32_t), &LEDcontrol::set_base10_leds); // Main LED controller object
