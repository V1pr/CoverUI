 ...
 * @brief YardForce SC600ECO non-uC CoverUI + HAT CoverUI Hatch for OpenMower https://github.com/ClemensElflein/OpenMower
 * @version 0.1
 * @date 2024-08-18
 *
...
unsigned int HatchLEGACYHAT::handle_button(unsigned int button_id, unsigned int press_cnt)
{
